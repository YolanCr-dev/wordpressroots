        ...
        <div class="container">
            ...
            <div class="highlighted_products-wrapper">
                ...
                <a href="{{ $wcproduct->get_permalink()}}" class="card-highlighted_product-wrapper">
                    <div class="card card-highlighted_product" style="background-color: {{ get_field('color', $wcproduct->get_id()) }} ; background-image: url({{ wp_get_attachment_url($wcproduct->get_image_id()) }})">
                        <h3> {{ $wcproduct->get_title() }} </h3>
                        <span> €{{ $wcproduct->get_price() }} </span>
                    </div>
                </a>
